...
/****************************************************************************
** $Id: qt/src/kernel/qfont.h   2.3.8   edited 2004-08-05 $
**
...
public:
    enum CharSet   { ISO_8859_1,  Latin1 = ISO_8859_1, AnyCharSet,
		     ...
		     ISO_8859_15, Latin9 = ISO_8859_15,
                     ISO_8859_16, Latin10 = ISO_8859_16,
		     KOI8R,
		     Set_Ja, Set_1 = Set_Ja,
		     Set_Ko,
		     Set_Th_TH,
...
//place alter_number_flag into QFont 
    bool        alter_number;  
    void	setAlterNumber(bool value);
    bool	getAlterNumber(void) const;
