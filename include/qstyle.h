...
/****************************************************************************
** $Id: qt/src/kernel/qstyle.h   2.3.6   edited 2002-10-02 $
**
...
public:
    ...
    virtual void drawProgressBackground(QPainter *p, QRect r, QColorGroup &g);
    virtual void drawProgressAmount(QPainter *p, QRect r, QRect bar, int x, int nu,
            const int unit_width, const int unit_height, QColorGroup &g);
    virtual void drawDialogBackground(QPainter *p, int x, int y, int w, int h, QBrush &bg);
    virtual void drawLineEditBackground(QPainter *p, int x, int y, int w, int h, QBrush &bg);
    ...
    virtual QSize scrollBarExtent(); // ### const 3.0
