...
/****************************************************************************
** $Id: qt/src/kernel/qfontmetrics.h   2.3.6   edited 2001-01-26 $
**
...
public:
   ...
   ~QFontMetrics();
    ...
    int		width( const QString &, int start, int end) const;
...
private:
    ...
    friend class QFontMetricsMoto;
    QFontMetricsMoto *d;
public:
    QFontMetricsMoto *moto() const { return d; }
};
