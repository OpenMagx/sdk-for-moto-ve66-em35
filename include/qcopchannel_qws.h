...
/****************************************************************************
** $Id: qt/src/kernel/qcopchannel_qws.h   2.3.6   edited 2001-08-24 $
**
...
//#ifdef QT_MULTILCD // used even without QT_MULTILCD defined by other component
    static void sendClients( const QCString &channel, const QCString &msg,
            const QByteArray &data, bool response=FALSE);
//#endif
