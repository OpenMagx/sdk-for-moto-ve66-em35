 ...
 *
 *  $Archive:   I:/BULL/DisplayImaging/archives/wtle/product/source/include/tstypes.h_v  $ 
 *  $Date:   May 23 2005 13:05:06  $
 *  $Revision:   1.14  $
 *
 ****************************************************************************/
 ...
 *  two pointers, eqivalent to the ANSI C 'ptrdiff_t" type.
 *
 *  <GROUP basictypes>
 */ 
...
/****************************************************************************
 *
 *  Typedef for a coordinate.
 *
 *  Description:
 *      May be used to describe a signed integer coordinate, a
 *      16.16 fixed point coordinate, or a 26.6 fixed point coordinate.
 *
 *  <GROUP basictypes>
 */
