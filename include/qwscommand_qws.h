...
struct QWSSetMorphModeCommand : public QWSCommand
{
    ...
    void setData( int morphMode, int winId ) {
        simpleData.morphMode = morphMode;
...
struct QWSRegionNameCommand : public QWSCommand
{
	...
	QWSCommand( QWSCommand::RegionName,
		    sizeof( simpleData ), (char *)&simpleData) { simpleData.pageId = -1; }
    ...
    void setDisplayId( int id ) { simpleData.pageId = id; }
...
struct QWSRegionMigrateCommand : public QWSCommand
{

    QWSRegionMigrateCommand() :
    QWSCommand( QWSCommand::RegionMigrate, sizeof( simpleData ),
        (char*)&simpleData ) {}
    struct SimpleData {
        int windowid;
        int pageid;
...
struct QWSOmgStopRateMode : public QWSCommand
{
    QWSOmgStopRateMode(int step = 0, int index = 0) :
        QWSCommand( QWSCommand::OmgStopRateMode, sizeof( simpleData ), (char*)&simpleData ) 
        {simpleData.stopStep = step; simpleData.index = index;}
