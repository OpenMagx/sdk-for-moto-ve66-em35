 ...
 * ----------- -------- ----------------------------------------
 * 20-sep-2006 Motorola Added conditional compilation for saving
 *                        memory
 */
#ifndef ICALTIME_H
#define ICALTIME_H
...
#ifndef MEMORY_SAVE_MODE
/** Returns the current time in the given timezone, as an icaltimetype. */
struct icaltimetype icaltime_current_time_with_zone(const icaltimezone *zone);
#endif // MEMORY_SAVE_MODE
 ...
 *  20-sep-2006    Motorola Added conditional compilation for saving
 *                            memory
 *  21-Sep-2007 Motorola    Get some function out from MEMORY_SAVE_MODE
 *	*/
 ...
 * Date		   Author	Comments
 * ----------- -------- ----------------------------------------
 * 20-sep-2006 Motorola    Removed __LINE__, __FUNCTION__ directives from
 *                            the error messages
 *                          Added conditional compilation for saving
 *                            memory
 */
...
#ifdef __GNUC__ca
    #define icalerror_warn(message) {fprintf(stderr,"%s\n", message);}
#else /* __GNU_C__ */
    #define icalerror_warn(message) {fprintf(stderr,"%s\n", message);}
#endif /* __GNU_C__ */
...
/* Assert with a message */
    ...
    #ifdef __GNUC__
        #define icalerror_assert(test,message) if(!(test)){fprintf(stderr,"%s\n", message);icalerror_stop_here(); abort();}
    #else /*__GNUC__*/
        #define icalerror_assert(test,message) if(!(test)){fprintf(stderr,"%s\n", message);icalerror_stop_here(); abort();}
    #endif /*__GNUC__*/
