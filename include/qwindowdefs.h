...
/****************************************************************************
** $Id: qt/src/kernel/qwindowdefs.h   2.3.6   edited 2001-07-23 $
**
...
Q_EXPORT char *q_getUiFlowName();			// get top application name running in a container, such as FL container.
Q_EXPORT void q_setUiFlowName(const char* new_name);	// set top application name running in a container, such as FL container.
