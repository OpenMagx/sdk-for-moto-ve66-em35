 ...
 * 06/18/08     Motorola       Check if defined macro INT8, INT16, etc. before typedef them
 *                             to avoid building error for some tool chain
*/

/****************************************************************************
** $Id: qt/src/tools/qglobal.h   2.3.6   edited 2003-05-22 $
**
...
#define QT_VERSION	236
#define QT_VERSION_STR	"2.3.6"


#if FEAT_LIBAPLOG_LEVEL == 0
//#include <stdio.h>
//#define printf(...)
#define qDebug(...)
#define qWarning(...)
...
//Changed for webKit, qt3 definitions
