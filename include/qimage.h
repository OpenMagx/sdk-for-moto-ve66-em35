...
/****************************************************************************
** $Id: qt/src/kernel/qimage.h   2.3.6   edited 2002-07-31 $
**
...
//
// Limit image size (width*height) to MegaPixels. Oversized images will not 
// be decoded, and imageIO status will be set to EZX_IMAGEIO_STATUS_OVERSIZE 
// in this case.
// 
#if defined(QT_QWS_IPAQ)
#define EZX_IMAGE_SIZE_WIDTH_LIMIT		2048
#define EZX_IMAGE_SIZE_HEIGHT_LIMIT		2048
#define EZX_IMAGE_SIZE_LIMIT		EZX_IMAGE_SIZE_WIDTH_LIMIT*EZX_IMAGE_SIZE_HEIGHT_LIMIT
#define EZX_IMAGE_FILE_SIZE_LIMIT	EZX_IMAGE_SIZE_LIMIT*2
#define EZX_IMAGEIO_STATUS_OVERSIZE	-100
#endif
