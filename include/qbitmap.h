...
/****************************************************************************
** $Id: qt/src/kernel/qbitmap.h   2.3.6   edited 2001-06-22 $
**
...
public:
    ...
    // MOT -- Added to support setting bitmaps from resource file data

    QBitmap( unsigned char* data,
             int width, int height, int depth, int linestep,
             bool alloc = false, int hasAlpha = 0)
        : QPixmap(data, width, height, depth, linestep, alloc, hasAlpha) {}
